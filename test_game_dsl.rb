# Requires the EchoesGameDSL module
require_relative 'echoes_game_dsl'

# Builds the game data
data = EchoesGameDSL.build do
  
  # =====================
  # Define Player Characters
  # Character definitions, Roles, Stats, and Abilities (Role / HP / TP / Skills)
  # =====================

  # Glenn - The Reluctant Warrior
  character "Glenn" do 
  ...
  # Victor - Scholar with support magic
  character "Victor" do
  ...
  location "City of Windwater" do
    ...
    # NPC Dialogues and Story Development (City of Windwater)
